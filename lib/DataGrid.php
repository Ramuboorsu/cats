...
class DataGrid
{
    ...
    public function draw($noOverflow = false)
    {
        ...
        if (!isset($this->showExportColumn) || $this->showExportColumn)
        {
            ...
            echo ('<th style="width:50px; border-right:1px solid red; ' . $this->globalStyle . '" align="center" id="cellHideShow'.$md5InstanceName.'"><div style="width:10px;">' . "\n");
       ...
       $currentColumnsKeys = array_keys($this->_currentColumns);
           ...
           if (isset($this->allowResizing) && $this->allowResizing == true)
           {
            ...
            {
                echo '<span style="font-weight:;"><nobr>',
                    $data['name'], '</nobr></span>';
            }
