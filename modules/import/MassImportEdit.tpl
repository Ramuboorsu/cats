                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="padding-top: 10px;">
                        <tr>
                            <td style="font-size: 14px; padding-top: 10px;">
                                <b>* - Fields that are required for this document to be converted into a candidate.</b><br>
                                <b>(Email should be unique.)</b>
                            </td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td valign="middle" align="left" style="padding-right: 5px;">
                                                            <input type="text" class="inputField firstName" id="firstName" name="firstName" value="<?php echo isset($this->document['firstName']) ? $this->document['firstName'] : ''; ?>" maxlength="30" onchange="validation();" required/>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fieldCell">
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td valign="middle" align="left" style="padding-right: 5px;">
                                                            <input type="text" class="inputField lastName" id="lastName" name="lastName" value="<?php echo isset($this->document['lastName']) ? $this->document['lastName'] : ''; ?>" maxlength="30" onchange="validation();" required/>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fieldCell">
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td valign="middle" align="left" style="padding-right: 5px;">
                                                            <input type="text" class="inputField address" id="address" name="address" value="<?php echo isset($this->document['address']) ? $this->document['address'] : ''; ?>" maxlength="30" onchange="validation();" required/>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fieldCell">
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td valign="middle" align="left" style="padding-right: 5px;">
                                                            <input type="text" class="inputField email" id="email" name="email" value="<?php echo isset($this->document['email']) ? $this->document['email'] : ''; ?>" maxlength="30" onchange="validation();" required/>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fieldCell">
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td valign="middle" align="left" style="padding-right: 5px;">
                                                            <input type="text" class="inputField homePhone" id="homePhone" name="homePhone" value="<?php echo isset($this->document['phone']) ? $this->document['phone'] : ''; ?>" maxlength="30" onchange="validation();" required/>
                                                        </td>
                                        ...
                                        <tr>
                                            <td class="fieldCell fieldTitle" colspan="2">
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td valign="middle" align="left" style="padding-right: 5px;">
                                                            <textarea name="skills" required id="skills" class="largeInputField" maxlength="255" onchange="validation();"><?php echo isset($this->document['skills']) ? trim($this->document['skills']) : ''; ?></textarea>
                                                        </td>
