    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="45%" valign="top">
                ...
                <?php echo number_format(count($this->importedDuplicates), 0); ?> <!--
                Developer-1 message chnaged.
                candidates were duplicates and not added.-->
                candidates were duplicates not added and Resume Saved
